...
function Products() {
        ...
        <>
            <div className="flex">
                ...
                <div
                    className={`
                flex-auto 
                ${urunTipiEkleModal || urunTipiDuzenleModal ? 'opacity-20' : null}
                    h-screen
                    px-8
                    py-8
                    bg-white
                        ...
                        <div className="flex-1 p-3">
                            <div className="p-4 shadow-md rounded-md text-left w-full mt-10" >
                                <label className="block">
                                    ...
                                    <input className="form-input mt-1 block w-full font-semibold p-2 border-2 border-gray-100 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-20 focus:rounded-sm" />
                                </label>
  ...
  "
            ...
            <div
                className={`
                ${!urunTipiEkleModal ? 'hidden' : 'animate__animated animate__jackInTheBox '}
